...
def main():
    ...
    parser.add_argument("--layers_num", type=int, default=12,
                        help=".")
    parser.add_argument("--input_model_path", type=str, default="E:\Dataset\mixed_corpus_bert_base_model.bin",
                        help=".")
    parser.add_argument("--output_model_path", type=str, default=r"E:\PycharmProject\paper2\NSP-BERT-main\models\uer_mixed_corpus_bert_base/bert_model.ckpt",
                        help=".")
