...
class Lead3Extractor:
    ...
    def extract(self, batch):
        ...
        sels=[[0,1,2] for i in range(batch.batch_size)]
        return res_src, res_tags, sels
...
class BertSumExtractor:
    ...
    def _build_ext_args(self):
        ...
        parser.add_argument("-train_steps", default=4, type=int)
    ...
    def extract(self, batch):
        exts, srctag,sels = self.trainer.predict(batch)
        exts = [ext[0] for ext in exts]
        return exts, srctag,sels
...
class GuidAbsHandler:
    ...
    def _build_abs_args(self):
        ...
        parser.add_argument("-rectifier", default=None)  # NSP  SOP
        # parser.add_argument("-rectifier", default="NSP")  # NSP  SOP
        # parser.add_argument("-rectifier", default="SOP")  # NSP  SOP
        parser.add_argument("-SOPmodelname", default="SOPrectifier/SOPexp/model_steps_9452.pt")
        # parser.add_argument("-subtag_scope", default=None)  # scope :set as 5 temporarily
        parser.add_argument("-subtag_scope", default=5)
...
if __name__ == "__main__":
    ...
    # parser.add_argument("-source_data_path", default=r'C:\Users\User\PycharmProjects\paper\Presum\PreSumm-master\bert_data')
    ...
    # abs = GuidAbsHandler('../scope5/model_step_24000.pt', args.source_data_path, args.result_path)
    abs = GuidAbsHandler('../scope7/model_step_22000.pt', args.source_data_path, args.result_path)
    # abs = GuidAbsHandler('../models/GuidAbs.model_step_222000.pt', args.source_data_path, args.result_path)
    # abs = GuidAbsHandler('../models/SentExt.model_step_25000.pt', args.source_data_path, args.result_path)
