...
#          data_file='SOPexp/ISNEXT/test.tsv',
#          model_file="",
#          pretrain_file='uncased_L-12_H-768_A-12/bert_model.ckpt',
#          data_parallel=True, vocab='uncased_L-12_H-768_A-12/vocab.txt',
#          save_dir='', max_len=128, mode='eval'
#          ):
def main(task='mrpc', train_cfg='SOP_config/train_mrpc.json',
        model_cfg='SOP_config/bert_base.json',
        data_file='SOPexp/ISNEXT/train.tsv',
        model_file="",
        pretrain_file="",
        data_parallel=True, vocab='uncased_L-12_H-768_A-12/vocab.txt',
        save_dir='SOPexp/ISNEXT', max_len=128, mode='train'
        ):
    """
